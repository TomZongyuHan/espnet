...
test_sets=test_Beijing

local_data_opts=/home/tomhzy/espnet/egs2/kespeech/asr1/data
dumpdir=/newdisk/data/KeSpeech

asr_config=conf/train_asr_branchformer.yaml
inference_config=conf/decode_asr_branchformer.yaml

use_lm=false  # To skip stage 5-8 lm model related
use_wordlm=false
